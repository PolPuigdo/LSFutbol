...
@section('content')
	...
	<form method="get" action="/compe">
		<button type="submit" class="btn btn-success" name="lliga" value="Lliga">Lliga</button>
	</form>
	<form method="get" action="/compe">
		<button type="submit" class="btn btn-success" name="copadelrei" value="Copa del Rei">Copa del Rei</button>
	</form>
